...
model = dict(
    ...
    backbone=dict(
        ...
        depth=50,widen_factor=1.0,dropout=0.5,input_channels=48,n_classes=400,load='ckpts/SqueezeTime_in1k_pretrain.pth',pos_dim=[56,28,14,7]),
    cls_head=dict(
        type='I2DHead',
        num_classes=600,
        in_channels=2048,
...
optim_wrapper = dict(
    optimizer=dict(type='SGD', lr=base_lr, momentum=0.9, weight_decay=0.00003),
