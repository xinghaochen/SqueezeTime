...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', interval=2, save_best='auto', max_keep_ckpts=5),
...
log_level = 'INFO'
load_from = 'ckpts/x3d_s_13x6x1_k400-rgb_top1_epoch_240.pth'
resume = False
...
optim_wrapper = dict(
    optimizer=dict(type='SGD', lr=0.01, momentum=0.9, weight_decay=1e-3),
