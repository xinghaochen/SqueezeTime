...
model = dict(
    type='FastRCNN',
    _scope_='mmdet',
    init_cfg=dict(type='Pretrained', checkpoint="ckpts/swin-tiny-p244-img160-f4-w877_in1k-pre_8xb8-amp-32x2x1-30e_kinetics400_top1_epoch_30.pth"),
    # backbone=dict(
...
train_pipeline = [
    ...
    dict(type='RandomRescale', scale_range=(160, 256)),
