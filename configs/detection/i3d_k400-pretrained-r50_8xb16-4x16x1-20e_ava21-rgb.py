...
model = dict(
    type='FastRCNN',
    _scope_='mmdet',
    init_cfg=dict(type='Pretrained', checkpoint="ckpts/i3d_imagenet-pretrained-r18_8xb8-32x2x1-100e_kinetics400-rgb_top1_epoch_85.pth"),
    # backbone=dict(
    ...
    # backbone=dict(
    #     type='mmaction.res2d_v6_5_fast_v2_ava',
    #     #pretrained2d=False,
    #     #pretrained='ckpts/res2d_v6_5_w1.pth',
    #     depth=50,widen_factor=1.0,dropout=0.5,input_channels=48,n_classes=400,load='ckpts/res2d_v6_5_w1_27_3_fast_v2_10_top1_epoch_98_70.87.pth',freeze_bn=False,spatial_stride=[1,2,2,1]),
    roi_head=dict(
        type='AVARoIHead',
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=20, val_begin=1, val_interval=2)
